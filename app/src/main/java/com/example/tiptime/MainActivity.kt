...
class MainActivity : AppCompatActivity() {
    ...
    val  CITY: String ="Ha Noi, VN"
    val API:String = "b9e5e7f8c206b6fbaf0cd6085ede58f0"
    ...
    inner class weatherTask() : AsyncTask<String,Void,String>()
    {
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                val weatherDescriptor = weather.getString("description")
                val address = jsonObj.getString("name")+", "+sys.getString("country")

                findViewById<TextView>(R.id.address).text = address
                findViewById<TextView>(R.id.update_at).text = updateAtText
                findViewById<TextView>(R.id.status).text = weatherDescriptor.capitalize()
